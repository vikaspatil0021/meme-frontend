                            ...
                            <div className="d-flex ms-2 ms-md-3">
                                <div className="d-flex justify-content-left mx-auto card-content" style={{ width: "1370px" }}>
                                    <div className="p-3 ps-2">
                                        ...
                                        <img class="rounded-5 cropped" src="http://res.cloudinary.com/dt55mivpf/image/upload/v1674375759/MYBLOG/POSTS/kgylnk6gjcjs5flkgmwj.jpg" alt="Card image cap" height="150" width="150" />
                                    </div>
